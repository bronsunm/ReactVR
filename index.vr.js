...
import {AppRegistry, asset, Image, Pano, Text, Sound, View, NativeModules, VideoPano, VideoControl, MediaPlayerState} from 'react-vr';
      ...
      <View>
        <View style={{transform: [{rotateY: rotation}]}}>
          ...
          <VideoPano
            ...
            source={asset(this.state.data.photos[this.state.nextLocationId].uri, {format: 'mp4', layout: 'SPHERE'})}
          />
